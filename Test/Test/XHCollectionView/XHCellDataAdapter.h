...
@interface XHCellDataAdapter : NSObject
...
/**
 *  XHCellDataAdapter's convenient method, used for UITableView.
 *
 ...
 *
 *  @return XHCellDataAdapter's object.
 */
...
/**
 *  XHCellDataAdapter's convenient method, used for UICollectionView.
 *
 *  @param cellReuseIdentifiers Cell's reused identifier.
 *  @param data                 Data, can be nil.
 *  @param cellType             Cell's type (The same cell, but maybe have different types).
 ...
 *  @return XHCellDataAdapter's object.
 */
+ (XHCellDataAdapter *)collectionCellDataAdapterWithCellReuseIdentifier:(NSString *)cellReuseIdentifiers data:(id)data
                                                             cellType:(NSInteger)cellType;
