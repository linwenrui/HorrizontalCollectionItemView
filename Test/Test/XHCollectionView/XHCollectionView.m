...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    XHBaseCustomCollectionCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:self.adapters[indexPath.row].cellReuseIdentifier forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    XHBaseCustomCollectionCell *cell = (XHBaseCustomCollectionCell *)[collectionView cellForItemAtIndexPath:indexPath];
    [cell selectedEvent];
    
    if (self.delegate && [self.delegate respondsToSelector:@selector(xhCollectionView:didSelectCell:indexPath:)]) {
        
        [self.delegate xhCollectionView:self didSelectCell:cell indexPath:indexPath];
    }
}
...
- (void)customCollectionCell:(XHBaseCustomCollectionCell *)cell event:(id)event {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(xhCollectionView:cell:event:)]) {
        
        [self.delegate xhCollectionView:self cell:cell event:event];
    }
}
